...
public class ErailSort {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// for each to get the text of the webelement throws Stale Element reference
		// exception but for loop works.
		/*
		 * for(WebElement wTN : trainName) { Thread.sleep(2000); String tname =
		 * wTN.getText(); strTrainName.add(tname); System.out.println(i++
		 * +". "+strTrainName); }
		 */
